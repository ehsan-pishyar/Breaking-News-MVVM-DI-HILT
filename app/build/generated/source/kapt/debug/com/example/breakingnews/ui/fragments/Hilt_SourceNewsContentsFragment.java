...
public abstract class Hilt_SourceNewsContentsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SourceNewsContentsFragment() {
    super();
  }

  Hilt_SourceNewsContentsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SourceNewsContentsFragment_GeneratedInjector) this.generatedComponent()).injectSourceNewsContentsFragment(UnsafeCasts.<SourceNewsContentsFragment>unsafeCast(this));
    }
  }
