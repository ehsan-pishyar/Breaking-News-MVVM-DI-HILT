...
public abstract class Hilt_SearchNewsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchNewsFragment() {
    super();
  }

  Hilt_SearchNewsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchNewsFragment_GeneratedInjector) this.generatedComponent()).injectSearchNewsFragment(UnsafeCasts.<SearchNewsFragment>unsafeCast(this));
    }
  }
