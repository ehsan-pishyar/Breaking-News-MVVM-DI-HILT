...
public abstract class Hilt_ArticleFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ArticleFragment() {
    super();
  }

  Hilt_ArticleFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ArticleFragment_GeneratedInjector) this.generatedComponent()).injectArticleFragment(UnsafeCasts.<ArticleFragment>unsafeCast(this));
    }
  }
