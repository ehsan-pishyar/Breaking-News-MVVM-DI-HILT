...
import com.example.breakingnews.data.di.AppModule_ProvideBaseUrlFactory;
import com.example.breakingnews.data.di.AppModule_ProvideNewsApiServiceFactory;
import com.example.breakingnews.data.di.AppModule_ProvideNewsDatabaseFactory;
import com.example.breakingnews.data.di.AppModule_ProvideNewsServiceFactory;
import com.example.breakingnews.data.di.AppModule_ProvideOkHttpFactory;
import com.example.breakingnews.data.di.AppModule_ProvideRetrofitFactory;
import com.example.breakingnews.databse.NewsDatabase;
import com.example.breakingnews.repository.MainRepository;
import com.example.breakingnews.ui.SearchNewsPage;
import com.example.breakingnews.ui.activities.MainActivity;
import com.example.breakingnews.ui.activities.SourceContentPage;
import com.example.breakingnews.ui.fragments.ArticleFragment;
import com.example.breakingnews.ui.fragments.MainFragment;
import com.example.breakingnews.ui.fragments.SavedNewsFragment;
import com.example.breakingnews.ui.fragments.SearchNewsFragment;
import com.example.breakingnews.ui.fragments.SourceNewsContentsFragment;
import com.example.breakingnews.ui.fragments.SourcePageFragment;
import com.example.breakingnews.ui.viewmodel.MainViewModel;
import com.example.breakingnews.ui.viewmodel.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC extends BaseApplication_HiltComponents.SingletonC {
  ...
  private volatile Object newsApiService = new MemoizedSentinel();

  private volatile Object newsApiHelper = new MemoizedSentinel();
  ...
  private String string() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = string;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideBaseUrlFactory.provideBaseUrl();
  ...
  private Retrofit retrofit() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = retrofit;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideRetrofitFactory.provideRetrofit(string(), okHttpClient());
  ...
  private NewsApiService newsApiService() {
    Object local = newsApiService;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = newsApiService;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideNewsServiceFactory.provideNewsService(retrofit());
          newsApiService = DoubleCheck.reentrantCheck(newsApiService, local);
        }
      }
    }
    return (NewsApiService) local;
  }

  private NewsApiHelperImpl newsApiHelperImpl() {
    return new NewsApiHelperImpl(newsApiService());
  }

  private NewsApiHelper newsApiHelper() {
    Object local = newsApiHelper;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = newsApiHelper;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideNewsApiServiceFactory.provideNewsApiService(newsApiHelperImpl());
          newsApiHelper = DoubleCheck.reentrantCheck(newsApiHelper, local);
        }
      }
    }
    return (NewsApiHelper) local;
  }
  ...
  private static final class ActivityRetainedCImpl extends BaseApplication_HiltComponents.ActivityRetainedC {
    ...
    private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
      ...
      @Override
      public void injectSearchNewsPage(SearchNewsPage searchNewsPage) {
      }
      ...
      @Override
      public void injectSourceContentPage(SourceContentPage sourceContentPage) {
      }
      ...
      private static final class FragmentCI extends BaseApplication_HiltComponents.FragmentC {
        ...
        @Override
        public void injectSearchNewsFragment(SearchNewsFragment searchNewsFragment) {
        }

        @Override
        public void injectSourceNewsContentsFragment(
            SourceNewsContentsFragment sourceNewsContentsFragment) {
        }

        @Override
        public void injectSourcePageFragment(SourcePageFragment sourcePageFragment) {
        }
    ...
    private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
      ...
      private MainRepository mainRepository() {
        return new MainRepository(singletonC.newsApiHelper(), singletonC.newsDatabase());
      }
      ...
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return Collections.<String, Provider<ViewModel>>singletonMap("com.example.breakingnews.ui.viewmodel.MainViewModel", (Provider) mainViewModelProvider());
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.example.breakingnews.ui.viewmodel.MainViewModel 
