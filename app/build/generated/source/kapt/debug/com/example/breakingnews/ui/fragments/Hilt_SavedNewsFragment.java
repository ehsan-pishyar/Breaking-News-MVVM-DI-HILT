...
public abstract class Hilt_SavedNewsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SavedNewsFragment() {
    super();
  }

  Hilt_SavedNewsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SavedNewsFragment_GeneratedInjector) this.generatedComponent()).injectSavedNewsFragment(UnsafeCasts.<SavedNewsFragment>unsafeCast(this));
    }
  }
