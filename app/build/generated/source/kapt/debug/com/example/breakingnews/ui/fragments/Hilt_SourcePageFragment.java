...
public abstract class Hilt_SourcePageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SourcePageFragment() {
    super();
  }

  Hilt_SourcePageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SourcePageFragment_GeneratedInjector) this.generatedComponent()).injectSourcePageFragment(UnsafeCasts.<SourcePageFragment>unsafeCast(this));
    }
  }
