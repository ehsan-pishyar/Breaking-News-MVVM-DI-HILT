...
public class MainFragmentDirections private constructor() {
  private data class ActionMainFragmentToArticleFragment(
    ...
    public override fun getActionId(): Int = R.id.action_mainFragment_to_articleFragment
  ...
  public companion object {
    public fun actionMainFragmentToArticleFragment(article: Articles): NavDirections =
