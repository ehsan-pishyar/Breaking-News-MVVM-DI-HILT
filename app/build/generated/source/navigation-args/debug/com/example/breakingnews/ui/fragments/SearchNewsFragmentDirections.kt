...
public class SearchNewsFragmentDirections private constructor() {
  private data class ActionSearchNewsFragmentToArticleFragment(
    ...
    public override fun getActionId(): Int = R.id.action_searchNewsFragment_to_articleFragment
  ...
  public companion object {
    public fun actionSearchNewsFragmentToArticleFragment(article: Articles): NavDirections =
